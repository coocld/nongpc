...
<a href="javascript:<?php if($itemid) { ?>Dsheet('<?php if($could_price) { ?><a href=&#34;message.php?action=send&typeid=2&touser=<?php echo $username;?>&title=<?php echo encrypt('我对您发布的“'.$title.'”很感兴趣', DT_KEY.'SEND');?>&#34; data-transition=&#34;slideup&#34;><span>发送报价</span></a>|<?php } ?>
...
<?php if($could_price) { ?>
<a href="message.php?action=send&typeid=2&touser=<?php echo $username;?>&title=<?php echo encrypt('我对您发布的“'.$title.'”很感兴趣', DT_KEY.'SEND');?>" data-transition="slideup"><div class="btn-blue" style="margin:10px 0;">发送报价</div></a>
<?php } ?>
<?php echo $content;?>
</div>
